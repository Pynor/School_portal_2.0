# Generated by Django 4.2.15 on 2025-04-11 14:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='tasklist',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_app.teacher', verbose_name='Creator'),
        ),
        migrations.AddField(
            model_name='tasklist',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_app.schoolsubject', verbose_name='School subject'),
        ),
        migrations.AddField(
            model_name='tasklist',
            name='task_for',
        ...
        migrations.AddIndex(
            model_name='tasklist',
            index=models.Index(fields=['title', 'is_archived'], name='task_app_ta_title_856051_idx'),
        ),
