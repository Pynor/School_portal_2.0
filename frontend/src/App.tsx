        ...
        const fetchData = async () => {
            ...
            try {
                ...
                if (!userData.is_staff && userData.student) {
                    const tasksGetResponse = await fetch(`${BASE_URL}/task_app/v1/api-task-list-get/?class=${userData.student.school_class}&status=archive&user_id=${userData.id}`, {
                        headers: {
                            'Access-Control-Request-Headers': 'Content-Type',
                            'Content-Type': 'application/json',
                        },
                ...
                <div className="content">
                    <main className="main-content">
                        <Routes>
                            ...
                            <Route path="/check-answers/:schoolClass/:taskListId/:status" element={<CheckAnswers userData={userData} />} />
