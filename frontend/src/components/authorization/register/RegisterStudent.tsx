            ...
            {studentsData.map((student, index) => (
              <div key={index} className="student-form">
                ...
                <div className="form-group">
                  <input
                    type="text"
                    className={`form-control ${errors[index]?.includes('School class is required') ? 'is-invalid' : ''}`}
                    id={`school_class_${index}`}
                    placeholder="Введите класс"
                    required
                    value={student.school_class}
                    onChange={(e) => handleInputChange(index, 'school_class', e.target.value)}
                  />
                  {errors[index]?.includes('School class is required') && (
                    <div className="invalid-feedback">School class is required</div>
                  )}
                </div>
              </div>
            ))}
